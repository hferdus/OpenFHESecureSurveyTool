# testing serial to file based on simple-integers-serial.py
# based on hundredClient_tenQuestion.py script
# aims to serialize all generated ciphertexts
# 10 questions for 100 clients, each 3 potential random choices per question
...
datafolder = "/home/humyraferdus/Downloads/tenClients/demoData"
