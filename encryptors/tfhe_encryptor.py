...
def serialize(datafolder,cc,ciphertext,kp1pk,kp1sk,kp2pk,kp2sk):
	...
	if not SerializeToFile(datafolder + f"/pk1.txt", kp1pk, serType):
            raise Exception(f"Error writing serialization of pk1.txt")
...
def main_action():
	...
	serialize(datafolder,cc,ciphertext,kp1.publicKey,kp1.secretKey,kp2.publicKey,kp2.secretKey)
	print(" ")
	print("-------Program End-------")
